...
import com.tonymock.retrofitmockinterceptor.mock_response.PostTestRequestMockMatchingSuccess2
...
class PostTestRequestMockMatching2Matcher : PostRequestMock {
    ...
    override fun customMatcher(requestBody: String): Boolean {
        ...
        return (requestObj.country == "Canada") && (requestObj.name == "mock_user") && (requestObj.id == 2)
    }
}